<template>
  <div class="grid grid-cols-2 divide-x h-screen bg-gray-900 text-gray-200">
    <div class="overflow-y-auto h-full">
      ...
      <div class="bg-black border-2">
        <div class="flex">
          ...
          <div class="flex-1 w-32">
            ...
            <button @click="code = ``"
              class="inline-block float-right mr-5 my-1 px-2 text-black bg-gray-300 rounded">CLEAR</button>
      ...
      <!-- Main Editor -->
      <Editor :editorSettings="editorSettings" v-model="code" />
    ...
    <div class="h-screen">
      ...
      <div class="overflow-y-scroll h-1/2 p-3">
        <svg v-if="isLoading" aria-hidden="true" style="display: block; margin-left: auto; margin-right: auto;" class="mt-36 w-8 h-8 mr-2 text-gray-700 animate-spin fill-yellow-400" viewBox="0 0 100 101"
...
export default {
  ...
  methods: {
    async sendCodeToRun() {
      ...
      let response = await this.$axios.request(reqOptions);
